# kalman-tracker-placeholder Specification

## Purpose
TBD - created by archiving change setup-app-architecture. Update Purpose after archive.
## Requirements
...
#### Scenario: Call tracking updates on tracker
