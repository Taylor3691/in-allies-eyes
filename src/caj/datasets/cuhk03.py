...
class CUHK03(BaseImageDataset):
    ...
    def _preprocess(self):
        """
        This function extracts images from raw cuhk-03.mat and creates standard split configurations.
        """
        ...
        os.makedirs(self.imgs_detected_dir, exist_ok=True)
        os.makedirs(self.imgs_labeled_dir, exist_ok=True)
